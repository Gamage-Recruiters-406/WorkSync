...
const UserAttendance = () => {
  ...
  const attendanceData = [
    { date: '2025-12-10', checkIn: '9.00 AM', checkOut: '5.00 PM', hours: '8h 0m', status: 'Present', statusColor: 'bg-green-100 text-green-800' },
    { date: '2025-12-11', checkIn: '8.45 AM', checkOut: '5.00 PM', hours: '8h 15m', status: 'Present', statusColor: 'bg-green-100 text-green-800' },
    { date: '2025-12-12', checkIn: '-', checkOut: '-', hours: '-', status: 'Absent', statusColor: 'bg-red-100 text-red-800' },
    { date: '2025-12-13', checkIn: '9.10 AM', checkOut: '-', hours: '-', status: 'Working', statusColor: 'bg-blue-100 text-blue-800' },
    { date: '2025-12-14', checkIn: '9.15 AM', checkOut: '5.30 PM', hours: '8h 15m', status: 'Late', statusColor: 'bg-yellow-100 text-yellow-800' },
  ];
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Bell size={20} style={{ color: '#087990' }} className="cursor-pointer" />
            <div className="flex items-center gap-2">
              <span className="text-sm font-medium text-gray-700">K.Perera</span>
        ...
        <div className="flex-1 overflow-auto p-6">
          ...
          <div className="rounded-lg p-8 mb-6 shadow-sm" style={{ backgroundColor: '#E5E7EB' }}>
                ...
                <>
                  ...
                  <div className="flex items-center gap-6 mb-6">
                    <div className="bg-white rounded-lg px-10 py-4 text-center">
                      <p className="text-xs text-gray-600 mb-2">Check IN Time</p>
                      <p className="text-xl font-bold text-gray-900">{formatCheckInTime()}</p>
                    </div>
                    <div className="bg-white rounded-lg px-10 py-4 text-center">
                      <p className="text-xs text-gray-600 mb-2">Working Hours</p>
                      <p className="text-xl font-bold text-gray-900">{getWorkingHours()}</p>
                    </div>
                  </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <h2 className="text-lg font-bold text-gray-900 mb-4">Personal Attendance Summary</h2>
                  ...
                  {attendanceData.map((row, index) => (
                    <tr key={index} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${row.statusColor}`}>
                          {row.status}
                        </span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <button 
                          ...
                          onClick={() => console.log(`Request correction for ${row.date}`)}
                        >
                          <Edit2 size={14} />
                          Request Correction
                        </button>
